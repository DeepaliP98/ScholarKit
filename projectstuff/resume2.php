...
<font size="4">
<form align="left" method="POST" action="preview.php">
   <div align="left" id="pi"><h3>PERSONAL INFO</h3>
	...
	<label>Last Name:</label><input class="txt" type="text" name="nam1" placeholder="Enter your last name"></input><br>
   ...
   <select name="cp">
	...
	<label>Contact Number:</label><input class="txt" type="tel" name="nam2" placeholder="Enter your number"></input><br>
   <label>Date Of Birth:</label><input class="dt" type="date" name="bday"></input><br>
   <label>Email:</label><input class="txt" type="text" name="email" placeholder="Enter your email id"></input><br>
   ...
   <label>To*</label><input class="dt" type="date" name="daya"></input><br>
   
   <label>Specialisation</label><input class="txt" type="text" name="spec"></input><br>
   ...
   <li>
   Research
   <label>Domain Name</label><input class="txt" type="text" name="res"></input><br>
